...
Kras_mt_Right<- read.csv("second_meta-analysis/AD KM-plots/Wang/MT-Type _RS.csv")
...
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Wang/MT-Type _LS.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_wt_Right<- read.csv("second_meta-analysis/AD KM-plots/Wang/WT-Type _RS.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Wang/WT-Type _LS.csv")
...
write.csv(x = IPD,"second_meta-analysis/AD KM-plots/Wang/Simulated_data.csv")
