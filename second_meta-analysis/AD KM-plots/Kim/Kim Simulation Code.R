...
### Mutated Right Side \
tot.events<-"9" #tot.events = total no. of events reported. If not reported, then tot.events="NA"
arm.id<-"Kras-mt_Right" #arm indicator
###END FUNCTION INPUTS
#Read in survival times read by Kras_mt_Left
Kras_mt_Right<- read.csv("second_meta-analysis/AD KM-plots/Kim/Right_Side_Mutated.csv")
...
tot.events<-"20" #tot.events = total no. of events reported. If not reported, then tot.events="NA"
arm.id<-"Kras-mt_Left" #arm indicator
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Kim/Left_Side_Mutated.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_wt_Right<- read.csv("second_meta-analysis/AD KM-plots/Kim/Right_Side_Wild_Type.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Kim/Left_Side_Wild_Type.csv")
...
write.csv(x = IPD,"second_meta-analysis/AD KM-plots/Kim/Simulated_data.csv")
