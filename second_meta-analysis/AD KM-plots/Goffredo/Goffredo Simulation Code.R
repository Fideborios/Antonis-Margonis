...
Kras_mt_Right<- read.csv("second_meta-analysis/AD KM-plots/Goffredo/Right_Side_Mutated.csv")
...
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Goffredo/Left_Side_Mutated.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_wt_Right<- read.csv("second_meta-analysis/AD KM-plots/Goffredo/Right_Side_Wild_Type.csv")
...
###END FUNCTION INPUTS
#Read in survival times read by Kras_wt_Left
Kras_mt_Left<- read.csv("second_meta-analysis/AD KM-plots/Goffredo/Left_Side_Wild_Type.csv")
...
write.csv(x = IPD,"second_meta-analysis/AD KM-plots/Goffredo/Simulated_data.csv")
